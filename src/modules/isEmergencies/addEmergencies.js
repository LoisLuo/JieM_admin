...
class AddEmergencies extends React.Component {
    constructor(props) {
        super();
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            ...
            if (!err) {
                ajax.post(
                    ajax.url(ajax.ports.emergencies.create),
                    formData,
                ).then(() => {
                    this.props.history.push('/emergencieslist')
                //    window.location.pathname="/admin/emergencieslist";
                }).complete(() => {
                });
            }
        });
...
export default Form.create({})(AddEmergencies);
